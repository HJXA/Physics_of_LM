...
#
# This code is modified from https://github.com/booydar/babilong/blob/main/babilong/prompts.py
# Original authors: Yuri Kuratov, Aydar Bulatov, Petr Anokhin, Ivan Rodkin, Dmitry Sorokin, Artyom Sorokin, Mikhail Burtsev
# Under Apache 2.0 License
#
# Zeyuan modified the prompts for qa1~qa5 tasks which I find slightly more helpful for models that were pretrained with only 100B or 1T tokens.
...
DEFAULT_TEMPLATE_ZEYUAN = {
    ...
    'qa3': f'{TASK_TEMPLATE}{USER_TEMPLATE}\nAnswer: ',
    'qa4': f'{TASK_TEMPLATE}{USER_TEMPLATE}\nAnswer: ',
    'qa5': f'{TASK_TEMPLATE}{USER_TEMPLATE}\nAnswer: ',
}
