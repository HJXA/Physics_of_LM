# Huggingface Transformer(Llama) Model Code with Canon Layers and Enhanced Features

**Author**: Zeyuan Allen-Zhu  

🔴 **Linear models like GLA, GDN, and Mamba2** (in their HF formats) are released inside [*../lingua_modified/huggingface*](../lingua_modified/huggingface).

---

## LlamaCanon Model

- **[`demo_pretrained.py`](demo_pretrained.py)**: Loads a pretrained LlamaCanon model from Huggingface.  
- **[`demo_newmodel.py`](demo_newmodel.py)**: Initializes a new LlamaCanon model from scratch for pretraining.  
...
> **Reference**: This functionality relies on the Lingua-modified codebase, available at [`lingua_modified`](../lingua_modified). It is compatible with our [model release](../canon_llama_results/), and supports for instance changing n_kv_heads and rope_theta.
