...
# 直接在这里修改所有配置参数
############################
TEST_DATA_PATH="/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part1/datasets/512_Padding/cfg3b/test.parquet"
CONFIG_PATH="/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part1/Lano-cfg/configs/cfg3b.json"
MODELS=(
  "/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part1/checkpoints/gpt_standard_Pretrain/cfg3b/checkpoint-100000"
  "/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part1/checkpoints/llama_rope/cfg3b/checkpoint-100000"
  "/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part1/checkpoints/llama_wpe/cfg3b/checkpoint-100000"
)
