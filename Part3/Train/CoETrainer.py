...
class CoETrainer(Trainer):
    def __init__(self, *args,swanlab_project,swanlab_experiment_name,  test_falg = False,CoE_Flag=True, Train_type=None, Store_Flag=True, **kwargs):
