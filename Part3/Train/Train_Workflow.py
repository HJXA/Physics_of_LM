...
from CoETrainer import CoETrainer
import torch
...
DATA_MODE = "no-answer"  # 可选: "no-answer" / "#" / "# #" / "#*10" / "attribute" / "raw" # 我现在tokenizer中的aplly_chat会自动加空格在Answer前
...
if TRAIN_TYPE == "PT":
	# MODEL_PATH = '/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part3/checkpoints/llama2_10m_long'
	# MODEL_PATH = '/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part3/checkpoints/llama2_20m'
	# MODEL_PATH = '/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part3/checkpoints/llama2_40m_long'
...
if TRAIN_TYPE in {"SFT", "LORA"}:
	...
	# MODEL_PATH = "/ruilab/jxhe/CoE_Monitor/Physics_of_LM/Part3/checkpoints/bioS_multi_permute_fullname/llama2_80m"
...
SEED = 42
PT_TRAIN_CONFIG = {
	"max_steps": 1600000,  # 训练的步数，不是前向的步数。前向的步数 = MAX_STEPS * GRADIENT_ACCUMULATION_STEPS # 原为80000
	"learning_rate": 0.001,
	"weight_decay": 0.1,
	"adam_beta1": 0.9,
	"adam_beta2": 0.98,
