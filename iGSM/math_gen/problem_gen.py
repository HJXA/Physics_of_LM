...
- `Num`: 模空间数字对象（支持加减乘）；
- `Expression`: 参数表达式树；
- `Problem`: 从图模板到自然语言题面/解答的完整构建流程。

该文件是数据生成主干：负责参数命名、问题文本、推理链与答案计算。
"""
