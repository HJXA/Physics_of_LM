...
#
# This code is modified from https://github.com/fla-org/flash-linear-attention/blob/main/fla/models/gla/configuration_gla.py (Jan/3/2025 version)
...
class GLACanonConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        zeyuan_split_init: bool = False,  # Zeyuan's edit note: whether to scale up the init for low-rank matrices (g_proj, gk_proj)
        zeyuan_layernorm: bool = False,   # Zeyuan's edit note: whether to use pytorch default RMSNorm (slightly more memory, but faster)
        fuse_norm: bool = True,
