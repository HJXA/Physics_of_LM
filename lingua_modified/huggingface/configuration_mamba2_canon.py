...
#
# This code is modified from https://github.com/huggingface/transformers/blob/v4.57.1/src/transformers/models/mamba2/configuration_mamba2.py
...
# - canon layers
# - disabled pad_token_id in default init
...
class Mamba2CanonConfig(PretrainedConfig):
    """
    ...
    def __init__(
        ...
        pad_token_id=None,  # Zeyuan edit: disabled pad_token_id
        bos_token_id=0,
        eos_token_id=2,
        expand=2,
        conv_kernel=4,
        ...
        intermediate_size: Optional[int] = None,  # Zeyuan's edit note: for MLP intermediate size; if None, intermediate_size = 2*hidden_size (gated MLP => 6d^2 params)
        **kwargs,
    ):
        ...
        self.noconv1d = False  # a flag to disable Mamba2's built-in conv1d
