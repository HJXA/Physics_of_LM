...
#
# This canon_helper.py file is newly added by Zeyuan Allen-Zhu, which is under the Apache 2.0 license, as stated in the root LICENSE file.
#
        ...
        class ShortConvolution(nn.Conv1d):
            ...
            def forward(
                ...
                if self.use_fast_conv1d:
                    ...
                    if self.activation is not None:
                        x = ACT2FN[self.activation](x)  # Note I'm using huggingface's ACT2FN here
...
def create_canon(dim, config):
    ...
    canon._zeyuan_no_reinit = True  # to bypass some HF model's nn.Conv1D reinitialization
    return canon
